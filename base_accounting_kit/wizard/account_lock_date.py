...
class AccountUpdateLockDate(models.TransientModel):
    ...
    company_id = fields.Many2one(comodel_name='res.company', string="Company",
                                 required=True)
    sale_lock_date = fields.Date(string="Date de verrouillage des ventes", help="Empêche la création et la modification des factures clients jusqu'à cette date.")
    purchase_lock_date = fields.Date(string="Date de verrouillage des achats", help="Empêche la création et la modification des factures fournisseurs jusqu'à cette date.")
    hard_lock_date = fields.Date(string="Verrouillage général",
